//
//  TicketIdContentViewController.m
...
@interface TicketIdContentViewController ()

@property(nonatomic,strong) NSString *info;

@end

@implementation TicketIdContentViewController
...
@implementation CustomNonSelectableTextViewForTicketId
